...
# Example : /info?uid=11111111&region=ME
# Regions Supported : ME | BD | PK (Only these 3 servers work)
...
def get_jwt_token_sync(region):
    ...
    global jwt_token
    # Only PK, ME and BD servers supported
    endpoints = {
        "ME": "https://raihan-access-to-jwt.vercel.app/token?uid=4344656844&password=RAIHANHACKER01",
    ...
    # If region not in supported list, use ME as default
...
def get_api_endpoint(region):
    # Only PK, ME and BD servers supported
    endpoints = {
        "ME": "https://client.ind.freefiremobile.com/GetPlayerPersonalShow",
...
def get_player_info():
    try:
        ...
        result['Supported_Regions'] = ['ME', 'BD', 'PK']
